...
export default class Footer extends React.Component {
  ...
  infoNewVersion() {
    Modal.info({
      ...
      content: (
        <div>
          <img src="https://os.alipayobjects.com/rmsportal/nyqBompsynAQCpJ.svg" alt="Ant Fable" />
          <p>
      ...
      <footer id="footer">
        <ul>
          <li>
            ...
            <div>
              <a target="_blank" rel="noopener noreferrer" href="https://github.com/antFB/antFB-init">antFB-init</a> -
          ...
          <li>
            ...
            <div><a href="http://diy-design.me/n.html?%2F&port=8002">Ant Fable Mobile</a> -
          ...
          <li>
            ...
            <div>
              <a target="_blank" rel="noopener noreferrer" href="https://github.com/antFB/antFB/issues">
            ...
            <div>
              <a target="_blank" rel="noopener noreferrer" href="https://github.com/antFB/antFB/issues/new">
          ...
          <li>
            ...
            <div>Powered by <a href="https://github.com/antFB/antFB">antFB</a></div>
